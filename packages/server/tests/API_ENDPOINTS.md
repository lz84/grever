# Grever API 全量端点清单（从 OpenAPI schema 生成，2026-06-26）
# 格式: METHOD PATH
# TOTAL: 333 endpoints

DELETE /api/v1/agent-schemes/{scheme_id}
...
GET /api/v1/scenarios/{status_id}/status
...
POST /api/v1/agents/{agent_id}/tasks/{agent_id}/tasks/{task_id}/claim
...
POST /internal/tasks/recover-timeout
