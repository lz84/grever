...
import pytest
from src.grasp.parsers.base import BaseParser, CognitiveEntry
from src.grasp.parsers.registry import ParserRegistry, register_parser, get_parser, list_parsers
