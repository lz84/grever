...
import pytest
import os
from src.grasp.parsers.md_parser import MDParser
from src.grasp.parsers.base import CognitiveEntry
...
class TestParserRegistration:
    ...
    def test_parser_registration_success(self, tmp_path):
        """测试注册机制"""
        from src.grasp.parsers.registry import ParserRegistry, get_parser
        from src.grasp.parsers.md_parser import MDParser
